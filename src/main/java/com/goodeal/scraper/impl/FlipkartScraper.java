...
/**
 * Flipkart scraper — delegates to the Python Scrapling microservice.
 */
@Service
public class FlipkartScraper extends AbstractScraper {

    private static final String STORE_NAME = "Flipkart";
    ...
    public List<PriceResult> scrape(String query) {
        ...
        try {
            ...
            String url = String.format(
                    "%s/scrape?store=flipkart&query=%s&max_results=%d",
